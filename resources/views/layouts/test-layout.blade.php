...
<head>
    ...
    <title>SIPERBA</title>
    <meta name="description" content="SIPERBA - Sistem Persediaan Barang">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    {{-- CSS ONLY di sini, tidak ada script JS di head --}}
...
<body>
    ...
    <!-- =====================================================
         ...
         4. Chart.js
         5. Library lain (butuh jQuery)
         6. @livewireScripts
         7. @stack('scripts') — script dari blade komponen
         8. Script inline lokal
    ====================================================== -->

    {{-- 1. jQuery — SATU KALI, PALING PERTAMA --}}
    ...
    {{-- 7. Stack scripts dari blade komponen --}}
    @stack('scripts')
        ...
        $(document).ready(function () {
            ...
            $('#menuToggle').on('click', function (e) {
                ...
                if ($(window).width() <= 768) {
                    ...
                    // Desktop: collapse/expand seperti template asli
